...
Exp = pd.read_csv("/account/bgong/workspace/TGP2012/Rat/in_vivo/Liver/Repeat/logFC.tsv.gz", sep="\t",index_col=0).T
...
hparam['save_path'] = '/account/xchen/workspace/TGx_GAN/AE4Exp/FC_repeat/'
...
df.index = Exp.index
df.to_csv('/account/xchen/workspace/TGx_GAN/Data/ExpCode_FC_repeat.tsv', sep='\t', index=True)